 ...
 )
{
  ...
  const int nBin = 2;
  Float_t xbins[nBin+1] = {700, YYY, 3000};
  if     (thePlot == 0) {xbins[0] = 500; xbins[nBin] = 2000;}
  else if(thePlot == 2) {xbins[0] =   0; xbins[nBin] =  500;}
  else if(thePlot == 9) {xbins[0] =  50; xbins[nBin] =  500;}
  else if(thePlot ==12) {xbins[0] = 0.0; xbins[nBin] = 1000;}
  else if(thePlot ==19) {xbins[0] = 0.0; xbins[nBin] = 1000;}
  else                  {xbins[0] = 700; xbins[nBin] = 3000;}
